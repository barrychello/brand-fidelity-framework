  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl">
        <h1 className="font-heading text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold uppercase leading-tight tracking-normal text-foreground max-w-4xl" style={{ fontFamily: "'Boldonse', sans-serif" }}>
          creating tomorrows<br className="hidden md:block" />
          from today’s
        </h1>
      </div>
